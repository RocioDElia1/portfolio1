...
<body id="inicio">
    ...
    <main class="container">
        <div class="row">
            <div class="col-12 mt-4 text-center div-pc">
                <a href="proyectos.php"><img src="images/Workspace_2_SVG.svg" class="pc"></a>
            </div>
        </div>
        <div class="row">
    ...
    <div class="whatsapp">
        <a href="https://api.whatsapp.com/send?phone=541164422649" title="Whatsapp"><i class="fab fa-whatsapp"></i></a>
    </div>

    ...
    <nav class="navbar navbar-expand-md mb-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5 col-12 mt-4">
                    ...
                    <p class="pb-sm-5">Estudiante de programaciòn con interes en aprender sobre informatica</p>
                    <a href="contacto.php" class="btn btn-rojo">Enviar mensaje</a>

                </div>
                <div class="col-sm-3 col-12 mt-4 offset-sm-2">
                    <img src="images/foto1.jpg" alt="Rocio D`Elia" title="Rocio D`Elia"
        ...
        <section id="tecnologias" class="color-gradiente pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="my-sm-5 text-white">Conocimientos</h2>
                    </div>
                </div>
                <div class="row">
        ...
        <section id="explaboral" class="container">
            <div class="row">
            ...
            <div class="row shadow bg-white rounded">
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-2 p-5 my-auto d-none d-sm-block">
                            <img src="images/ropa2.jpg" class="img-fluid baw" >
                        </div>
                        <div class="col-12- col-sm-10 p-3">
                            <h3>Vendedora</h3>
                            <h4>Venta de indumentaria</h4>
                            <h5>2017-2018</h5>
                            <p>Venta de productos en linea y en local. Indumentaria formal,informal.Todos los talles.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12">
                <div class="row">
                    <div class="col-2 p-5 my-auto d-none d-sm-block">
                        <img src="images/pc.jpg" class="img-fluid baw">
                    </div>
                    <div class="col-12- col-sm-10 p-3">
                        <h3>Soporte tecnico Pc</h3>
                        <h4>Tecnico Pc</h4>
                        <h5>2019</h5>
                        <p>Mantenimiento de pc via remoto y de forma presencia,asistencias, resolucion de fallas y servicios.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-2 p-5 my-auto d-none d-sm-block">
                            <img src="images/matematica.jpg" class="img-fluid baw">
                        </div>
                        <div class="col-12 col-sm-10 p-3">
                            <h3>Clases particulares de matematica</h3>
                            <h4>Profesora</h4>
                            <h5>jul 2012 - jun 2018</h5>
                            <p>Enseñanza y apoyo en matemàtica. Primaria y Secundario. Seguimiento y orientacion con trabajos y examenes.
                    </div>
                </div>
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12- col-sm-10 p-3">
                            ...
                            <h4>Vendedora</h4>
                            <h5>2020-2021</h5>
                            <p>Atencion al cliente, venta de productos, carga de sube, impresiones.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="row">
                        <div class="col-2 p-5 my-auto d-none d-sm-block">
                            <img src="images/que-es-un-call-center-image_header.webp" class="img-fluid baw" title="certificado">
                        </div>
                        <div class="col-12 col-sm-10 p-3">
                        ...
                        <h3>Fullstack Arg</h3>
                            <h4>Call center</h4>
                            <h5>2022</h5>
                            <p>Venta de autos 0km, armado de presupuesto,boleto de venta,atencion al publico,publicidad </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row shadow bg-white rounded p-1">
                <div class="col-12 col-sm-6">
                    <div class="row">
                        <div class="col-3 py-3 my-auto d-none d-sm-block">
                            <img src="images/untref.jpg" class="img-fluid baw" title="depcsuite">
                        </div>
                        <div class="col-12- col-sm-10 p-3">
                            <h3>Ingenieria en Informatica</h3>
                            <h4>UNTREF</h4>
                            <h5>2017 - 2019</h5>
                            <p>https://www.untref.edu.ar/</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6">
                    <div class="row">
                        <div class="col-3 py-3 my-auto d-none d-sm-block">
                            <img src="images/isi-logo.png" class="img-fluid baw" title="depcsuite">
                        </div>
                        <div class="col-12- col-sm-10 p-3">
                            <h3>Redes y Seguridad Informatica</h3>
                            <h4>Instituto San Isidro</h4>
                            <h5>2019-2020</h5>
                            <p>https://institutosanisidro.com.ar/sede-san-isidro/</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-12- col-sm-10 p-3">
                            ...
                            <h4>Escuela.M.Pilar</h4>
                            <h5>2021</h5>
                            <p>https://cmfp.pilar.gov.ar/cmfp/front/</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="formacion" class="container mb-5">
            ...
            <div class="row shadow bg-white rounded p-1">
                <div class="col-12 col-sm-6">
                    <div class="row">
                        <div class="col-2 py-3 my-auto d-none d-sm-block">
                            <img src="images/descarga.png" class="img-fluid baw" title="depcsuite">
                        </div>
                        <div class="col-12- col-sm-10 p-3">
                            <h3>Formacion del idioma ingles</h3>
                            <h4>AIDIP</h4>
                            <h5>Actualmente: en curso</h5>
                            <p></p>
                        </div>
                    </div>
</div>
